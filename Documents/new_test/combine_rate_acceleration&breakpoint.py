...
tdms_filename = r'/media/longfu/Windows/Users/86183/Desktop/Effect of T7 gp2.5 on DNAp revealed by single-molecule force spectroscopy/DNAp_noSSB_noBSA/20pN_raw/' + name + '.tdms'
...
EEDds = tWLC(force)
EEDss = FJC(force)
ssDNA_correction_factor = 0.346
def ssDNA_percentage(F):
    ssDNA_percentage = (distance - tWLC(F)) / (FJC(F) - ssDNA_correction_factor - tWLC(F))
    return(ssDNA_percentage)

save_overview_figure = r'/media/longfu/Windows/Users/86183/Desktop/Effect of T7 gp2.5 on DNAp revealed by single-molecule force spectroscopy/DNAp_noSSB_noBSA/20pN_processing/overview_' + name + '-cycle#'+ cycle + '.png'
...
excel_filename = r'/media/longfu/Windows/Users/86183/Desktop/Effect of T7 gp2.5 on DNAp revealed by single-molecule force spectroscopy/DNAp_noSSB_noBSA/20pN_processing/'+ name + '-cycle#'+ cycle + '.xlsx'
...
save_segment_figure = r'/media/longfu/Windows/Users/86183/Desktop/Effect of T7 gp2.5 on DNAp revealed by single-molecule force spectroscopy/DNAp_noSSB_noBSA/20pN_processing/segment_' + name + '-cycle#'+ cycle + '.png'
plt.figure()
plt.plot(x, y, 'o')
plt.plot(xHat, yHat, '-')
plt.grid()
...
save_acceleration_figure = r'/media/longfu/Windows/Users/86183/Desktop/Effect of T7 gp2.5 on DNAp revealed by single-molecule force spectroscopy/DNAp_noSSB_noBSA/20pN_processing/acceleration_' + name + '-cycle#'+ cycle + '.png'
...
data_4 = {'event_number': event_number,
        'rate(bp/s)':my_slopes,
        'duration(ms)':event_duration,
        'fragment_length(bp)':fragment_length,
        'SSR':event_ssr,
        'SST':event_sst,
        'R2values':R2values}
data_5 = {'beta':beta,
